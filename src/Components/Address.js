...
export default function Address() {
  return (
    <div className="flex items-center mt-14">
      ...
      <div className="text-gray-600 text-lg">Flashcard</div>
      <div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
      ...
      <div className="text-gray-600 text-lg">Mathematics</div>
      <div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
      ...
      <div className="text-blue-900 font-semibold text-lg">Relation and Function</div>
    </div>
  );
}
