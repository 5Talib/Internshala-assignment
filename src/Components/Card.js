...
export default function Card() {
  ...
  const none = {};
  return (
    <div className="relative persecptive-40 cursor-pointer">
      <div
        className={`${flipped ? "flipped" : ""}`}
        onClick={() => setFlipped(!flipped)}
      >
        <div className=" h-[485px] w-[712px] flex flex-col justify-between mx-auto my-auto back">
          <div className="h-[393px] bg-gradient-to-br from-blue-900 via-blue-800 to-blue-500 rounded-[32px] ">
            <div className="flex flex-row items-center justify-between">
              <div className="mt-[34px] ml-[34px]">
                <svg
            ...
            <div className="font-bold text-white flex items-center justify-center text-3xl mt-[110px]">
              9 + 6 + 7x - 2x - 3
            </div>
          </div>
          <div className="h-[60px] px-[50px] flex flex-row items-center justify-center">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="30"
            ...
            <div className="flex items-center mx-[140px] justify-center">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="60"
              ...
              <div className="mx-[43px] text-gray-700 font-bold">01/10</div>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="60"
        ...
        <div className=" h-[485px] w-[712px] flex flex-col justify-between mx-auto my-auto front">
          <div className="h-[393px] bg-gradient-to-br from-blue-900 via-blue-800 to-blue-500 rounded-[32px] ">
            <div className="flex flex-row items-center justify-between">
              <div className="mt-[34px] ml-[34px]">
                <svg
