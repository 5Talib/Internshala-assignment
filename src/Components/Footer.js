  ...
  return (
    <div className="flex flex-row items-center justify-between mt-[90px]">
      <div className="flex items-center">
        <div className="h-[50px] w-[50px] flex items-center justify-center drop-shadow-xl bg-slate-50 rounded-full">
          <img
            className="h-[34px] w-[44px] rounded-full"
      ...
      <div className="flex items-center">
        ...
        <div className="font-semibold bg-gradient-to-b from-blue-900 via-blue-800 to-blue-500 ... inline-block ... text-transparent ... bg-clip-text text-3xl ml-2">
          Create Flashcard
        </div>
      </div>
    </div>
